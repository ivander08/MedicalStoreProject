...
public class RegistrationForm extends JFrame {
    ...
    private class userEvents
        ...
        taOutput.setText("");
        lbConfirm.setText("please accept the term and conditions");
                }
              }
            ...
            if(obj == btnSubmit && newName.equals("") || newMobile.equals("") || newAddress.equals("")  ){
                taOutput.setText("");
                lbConfirm.setText("Field cannot be blank!");
            }
            }
        }
